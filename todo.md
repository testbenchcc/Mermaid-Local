...
-[] There is still an issue with selecting a node and highlighting in the left panel. Here is the console output when I click a node that does not highight the left panel node words red.
```console
