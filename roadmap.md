# Mermaid-Local Roadmap

This file tracks medium- and long-term goals for the project.

## Short-term
- Stabilize node connection tools (Connect New Node / Connect Existing Node). *(Initial pass implemented: modals now expose full configuration for nodes and links with live preview.)*
...
- Add additional diagram templates and examples.
